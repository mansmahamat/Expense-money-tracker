...
<div className="flex justify-center my-8 mx-4 md:mx-0">
   <form onSubmit={onSubmit} autoComplete="off" className="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
      <h2 className="text-4xl mb-6 text-teal-400 text-center font-extrabold tracking-tight">
         Nouvelle transaction
      </h2>
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="divInput">
            <label className="input" htmlFor='text'>Libellé</label>
            <input value={text} onChange={(e) => setText(e.target.value)} id="text" placeholder="Entrez le libellé" className="appearance-none block w-full bg-white border-teal-400 font-medium border  rounded-lg py-3 px-3 leading-tight focus:outline-none" type='text'  required />
         </div>
         
         <div className="divInput">
            <label className="input" htmlFor='amount'>Montant <span className="lowercase">(- pour négatif)</span> </label>
         ...
         <div className="divInput">
            <label className="input" htmlFor='amount'>Choisir une catégorie </label>
